...
<template>
  <div class="min-h-screen flex flex-col bg-white">
    ...
    <div class="flex items-center px-4 pt-4 pb-2">
      ...
      <h1 class="flex-1 text-center text-lg font-bold">注册账号</h1>
      <span class="w-6" />
    </div>

    <div class="px-6 flex-1">
      <p class="text-sm text-gray-400 mb-6 mt-2">欢迎加入上海公寓租赁平台</p>
      ...
      <van-form @submit="onSubmit">
        ...
        <van-field
          ...
          :rules="[
            ...
            { validator: (val: string) => val === form.password, message: '两次密码不一致' },
          ]"
          class="mb-3"
        >
          <template #left-icon>
